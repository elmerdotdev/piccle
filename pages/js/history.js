...
function init() {
    ...
    // Close popup
    document.querySelector('.history-wrapper__popup-overlay .close-btn').addEventListener('click', () => {
        document.querySelector('.history-wrapper__popup-overlay').classList.remove('show')
    })
